...
<html>
    ...
    <body>
        ...
        <form:form method="POST" action="saveShippingInformation" modelAttribute="shippingInformationPaymentDto">
            <h2>ShippingInformationp</h2>
            ...
            <form:select path="paymentId" items="${paymentList}" itemLabel="paymentName" itemValue="paymentId"/>
